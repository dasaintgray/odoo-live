...
# class cBizPaymenAPI(models.Model):
#     """
#     CircuitBiz
#     Payment API
#     -- Also serves as database log for payment
#     """
#     _name='cbiz.api.payment'

#     invoice = fields.Many2one("account.move",string="Invoice",required=True,domain=[('payment_state','in',['not_paid','partial'])])
#     journal = fields.Many2one("account.journal",string="Payment Journal",required=True,domain=[('type','in',['cash','bank'])])
#     date = fields.Date(string="Payment Date",required=True,)
#     payment_amount = fields.Integer(string="Payment Amount",required=True,)
#     company = fields.Many2one("res.partner", string="Company",required=True,)

#     @api.model
#     def create(self,values):
#         createpayment = self.create_payment(values)
...
#                     "company_id": company
#                 }])
#         confirmation = payment.action_create_payments()
#         return confirmation
