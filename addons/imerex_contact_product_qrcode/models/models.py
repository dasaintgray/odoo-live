...
class Partners(models.Model):
    ...
    def generate_qr(self):
        if qrcode and base64:
            ...
            return self.env.ref(
                'imerex_contact_product_qrcode.print_qr').report_action(self, data={
...
class Products(models.Model):
    ...
    def generate_qr(self):
        if qrcode and base64:
            ...
            self.write({'qr': qr_image})
            return self.env.ref(
                'imerex_contact_product_qrcode.print_qr2').report_action(self, data={
...
class ProductTemplate(models.Model):
    ...
    def generate_qr(self):
        ...
        for rec in product:
            rec.generate_qr()
        return self.env.ref('imerex_contact_product_qrcode.print_qr2').report_action(
