odoo.define('imerex_multi_branch.branch', function(require){
    ...
    models.load_models({
        model: 'res.branch',
        fields: ['id','name','receipt_name','receipt_branchname','ksa_address', 'street', 'street2','city','state_id','country_id','email','phone','website','twitter','facebook'],
        ...
        class extends OrderReceipt {
            get receiptEnv() {
                ...
                if (this.env.pos.branch){
                    ...
                    var branch_state = this.env.pos.branch.state_id[1];
                    ...
                    console.log(receipt_render_env);
                }
