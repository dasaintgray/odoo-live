odoo.define('imerex_pos_combo_product.ProductScreen', function (require) {
"use strict";
                ...
                if(!_.isEmpty(combo_product)) {
                    ...
                    if (confirmed) {
                        if(payload >= 0) {
                            ...
                            order.manage_combo_products_selected(checked_req_dom, checked_un_req_dom);
                            if(payload > 0) {
                                orderline.set_unit_price((orderline.get_unit_price() - parseFloat(orderline.get_extra_price_combo())) + payload);
