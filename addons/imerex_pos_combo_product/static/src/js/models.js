odoo.define('imerex_pos_combo_product.models', function (require) {
    "use strict";
    ...
    models.load_models({
        model: 'product.combo',
        fields: ['product_template_id', 'is_required_product', 'is_include_in_main_product_price', 'category_id', 'product_ids', 'no_of_items','combo_pricing'],
    ...
    models.Order = models.Order.extend({
        ...
        get_product_data: function(category, product_temp_id) {
            ...
            let result_req_quantity = {};
            let result_unreq_quantity = {};
                ...
                if(!_.isEmpty(value.product_template_id) && category && value.product_template_id[0] === product_temp_id && category == value.category_id[0]) {
                    if (value.is_required_product) {
                        result_required = {
                            ...
                            'combo_id': value.id,
                            'combo_pricing': value.combo_pricing,
                        },
                        _.each(value.product_ids, function(result_qty) {
                            result_req_quantity[result_qty] = self.pos.db.combo_qty[result_qty]
                        })
                    }
                    else {
                        result_unrequired = {
                        ...
                        _.each(value.product_ids, function(result_qty) {
                            result_unreq_quantity[result_qty] = self.pos.db.combo_qty[result_qty]
                        })
                    }
                }
                result = {
                    ...
                    'req_qty': result_req_quantity,
                    'unreq_qty': result_unreq_quantity,
                }
            });
            return result;
        },
        set_pricelist: function (pricelist) {
            ...
            let lines_to_recompute = _.filter(this.get_orderlines(), function (line) {4
    ...
    models.Orderline = models.Orderline.extend({
        ...
        export_for_printing: function() {
            let receipt = _super_orderline.export_for_printing.call(this);
            let self = this;
